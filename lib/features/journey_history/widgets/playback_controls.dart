      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text(startTimeStr, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w500)),
                Expanded(
                  child: SliderTheme(
                ...
                Text(endTimeStr, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w500)),
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                // Speed Selector & Follow Camera Toggle
                Row(
                  children: [
                    // Tốc độ phát
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              ...
                              size: 18,
                              color: state.followCamera ? theme.colorScheme.primary : theme.colorScheme.outline,
                            ),
                            if (isDesktop) ...[
